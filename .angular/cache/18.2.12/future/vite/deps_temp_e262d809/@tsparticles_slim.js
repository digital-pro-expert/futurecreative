...
function loadEasingQuadPlugin(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addEasing(EasingType.easeInQuad, (value) => value ** 2, false);
    yield engine.addEasing(EasingType.easeOutQuad, (value) => 1 - (1 - value) ** 2, false);
    yield engine.addEasing(EasingType.easeInOutQuad, (value) => value < 0.5 ? 2 * value ** 2 : 1 - (-2 * value + 2) ** 2 / 2, false);
    yield engine.refresh(refresh);
  });
}
...
function drawEmoji(data, image) {
  const {
    context,
    opacity
  } = data, half9 = 0.5, previousAlpha = context.globalAlpha;
  if (!image) {
    return;
  }
...
var EmojiDrawer = class {
  ...
  particleInit(_container, particle) {
    ...
    const emojiOptions = typeof emoji === "string" ? {
      ...
      font: defaultFont,
      padding: noPadding
    }, shapeData), emoji), font = emojiOptions.font, value = emojiOptions.value;
...
function loadEmojiShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addShape(new EmojiDrawer(), refresh);
  });
}
...
function loadExternalAttractInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalAttract", (container) => {
...
function loadExternalBounceInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalBounce", (container) => {
...
var Bubbler = class extends ExternalInteractorBase {
  constructor(container, engine) {
    ...
    this._clickBubble = () => {
      ...
      const query = container2.particles.quadTree.queryCircle(mouseClickPos, distance, (p) => this.isEnabled(p)), {
        bubble
      } = container2;
      for (const particle of query) {
        if (!bubble.clicking) {
...
function loadExternalBubbleInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalBubble", (container) => {
...
function loadExternalConnectInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalConnect", (container) => {
...
function loadExternalGrabInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalGrab", (container) => {
...
function loadExternalPauseInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalPause", (container) => {
...
function loadExternalPushInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalPush", (container) => {
...
function loadExternalRemoveInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalRemove", (container) => {
...
var Repulser = class extends ExternalInteractorBase {
  constructor(engine, container) {
    ...
    this._clickRepulse = () => {
      ...
      const repulse = container2.repulse ?? {
        particles: []
      };
      if (!repulse.finish) {
        if (!repulse.count) {
    ...
    this._processRepulse = (position, repulseRadius, area, divRepulse) => {
      ...
      const {
        ...
        factor,
        maxSpeed
      } = repulseOptions, easingFunc = this._engine.getEasing(easing), velocity = (divRepulse?.speed ?? speed) * factor;
      for (const particle of query) {
        const {
          dx,
          dy,
          distance
        } = getDistances(particle.position, position), repulseFactor = clamp(easingFunc(easingOffset - distance / repulseRadius) * velocity, minSpeed, maxSpeed), normVec = Vector.create(!distance ? velocity : dx / distance * repulseFactor, !distance ? velocity : dy / distance * repulseFactor);
...
function loadExternalRepulseInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalRepulse", (container) => {
...
function loadExternalSlowInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("externalSlow", (container) => {
...
function parseImageBlock(byteStream, gif, avgAlpha, getFrameIndex, getTransparencyIndex, progressCallback) {
  return __async(this, null, function* () {
...
function parseBlock(byteStream, gif, avgAlpha, getFrameIndex, getTransparencyIndex, progressCallback) {
  return __async(this, null, function* () {
    switch (byteStream.nextByte()) {
...
function decodeGIF(gifURL, progressCallback, avgAlpha) {
  return __async(this, null, function* () {
...
function drawGif(data) {
  ...
  const pos = {
    x: -image.gifData.width * half5,
    y: -image.gifData.height * half5
...
var ImageDrawer = class {
  constructor(engine) {
    ...
    this.loadImageShape = (imageShape) => __async(this, null, function* () {
      if (!this._engine.loadImage) {
        throw new Error(`${errorPrefix} image shape not initialized`);
      }
      yield this._engine.loadImage({
        gif: imageShape.gif,
  ...
  init(container) {
    return __async(this, null, function* () {
      ...
      for (const imageData of options.preload) {
        yield this._engine.loadImage(imageData);
      }
    });
  }
  loadShape(particle) {
...
function addLoadImageToEngine(engine) {
  ...
  engine.loadImage = (data) => __async(this, null, function* () {
...
function loadImageShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    addLoadImageToEngine(engine);
    const preloader = new ImagePreloaderPlugin(engine);
    yield engine.addPlugin(preloader, refresh);
    yield engine.addShape(new ImageDrawer(engine), refresh);
  });
}
...
function loadLifeUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addParticleUpdater("life", (container) => __async(this, null, function* () {
...
function loadLineShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addShape(new LineDrawer(), refresh);
  });
}
...
function loadParallaxMover(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addMover("parallax", () => {
  ...
  interact(p1) {
    ...
    for (const p2 of query) {
      ...
      const pos2 = p2.getPosition(), {
        dx,
        dy
      } = getDistances(pos1, pos2), rotate = p1.options.move.attract.rotate, ax = dx / (rotate.x * attractFactor), ay = dy / (rotate.y * attractFactor), p1Factor = p2.size.value / p1.size.value, p2Factor = identity4 / p1Factor;
...
function loadParticlesAttractInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("particlesAttract", (container) => {
...
function loadParticlesCollisionsInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addInteractor("particlesCollisions", (container) => {
...
var CircleWarp = class extends Circle {
  constructor(x, y, radius, canvasSize) {
    ...
    this.canvasSize = __spreadValues({}, canvasSize);
  }
  contains(point) {
    const {
      width,
...
function loadLinksInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("particlesLinks", (container) => __async(this, null, function* () {
  ...
  constructor(container, engine) {
    this._drawLinkLine = (p1, link) => {
      ...
      container2.canvas.draw((ctx) => {
        ...
        const width = p1.retina.linksWidth ?? minWidth, maxDistance = p1.retina.linksDistance ?? minDistance7, {
          backgroundMask
        } = options;
        drawLinkLine({
          context: ctx,
...
function loadLinksPlugin(engine, refresh = true) {
  return __async(this, null, function* () {
...
function loadParticlesLinksInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield loadLinksInteraction(engine, refresh);
    yield loadLinksPlugin(engine, refresh);
  });
}
...
function drawPolygon(data, start, side) {
  const {
    context
  } = data, sideCount = side.count.numerator * side.count.denominator, decimalSides = side.count.numerator / side.count.denominator, interiorAngleDegrees = piDeg * (decimalSides - sidesOffset) / decimalSides, interiorAngle = Math.PI - degToRad(interiorAngleDegrees);
  if (!context) {
    return;
  }
  context.beginPath();
...
var PolygonDrawerBase = class {
  draw(data) {
    const {
      particle,
      radius
    } = data, start = this.getCenter(particle, radius), side = this.getSidesData(particle, radius);
...
function loadGenericPolygonShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addShape(new PolygonDrawer(), refresh);
  });
}
function loadTriangleShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addShape(new TriangleDrawer(), refresh);
  });
}
function loadPolygonShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield loadGenericPolygonShape(engine, refresh);
    yield loadTriangleShape(engine, refresh);
  });
}
...
function loadRotateUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addParticleUpdater("rotate", (container) => {
...
function drawSquare(data) {
  const {
    context,
    radius
  } = data, fixedRadius = radius / fixFactor, fixedDiameter = fixedRadius * double10;
...
function loadSquareShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addShape(new SquareDrawer(), refresh);
  });
}
...
function drawStar(data) {
  const {
    ...
    particle,
    radius
  } = data, sides6 = particle.sides, inset = particle.starInset ?? defaultInset;
...
function loadStarShape(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addShape(new StarDrawer(), refresh);
  });
}
...
function loadStrokeColorUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield engine.addParticleUpdater("strokeColor", (container) => {
...
function loadSlim(engine, refresh = true) {
  return __async(this, null, function* () {
    engine.checkVersion("3.8.0");
    yield loadParallaxMover(engine, false);
    yield loadExternalAttractInteraction(engine, false);
    yield loadExternalBounceInteraction(engine, false);
    yield loadExternalBubbleInteraction(engine, false);
    yield loadExternalConnectInteraction(engine, false);
    yield loadExternalGrabInteraction(engine, false);
    yield loadExternalPauseInteraction(engine, false);
    yield loadExternalPushInteraction(engine, false);
    yield loadExternalRemoveInteraction(engine, false);
    yield loadExternalRepulseInteraction(engine, false);
    yield loadExternalSlowInteraction(engine, false);
    yield loadParticlesAttractInteraction(engine, false);
    yield loadParticlesCollisionsInteraction(engine, false);
    yield loadParticlesLinksInteraction(engine, false);
    yield loadEasingQuadPlugin(engine, false);
    yield loadEmojiShape(engine, false);
    yield loadImageShape(engine, false);
    yield loadLineShape(engine, false);
    yield loadPolygonShape(engine, false);
    yield loadSquareShape(engine, false);
    yield loadStarShape(engine, false);
    yield loadLifeUpdater(engine, false);
    yield loadRotateUpdater(engine, false);
    yield loadStrokeColorUpdater(engine, false);
    yield loadBasic(engine, refresh);
  });
}
export {
  loadSlim
